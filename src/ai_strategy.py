...
try:
    ...
    print("⚠️ XGBoost 설치 필요: pip install xgboost scikit-learn")
...
if __name__ == "__main__":
    ...
    if not XGBOOST_AVAILABLE:
        print("XGBoost를 설치하세요: pip install xgboost scikit-learn")
    else:
        print("XGBoost 사용 가능 ✅")
        print("\n사용법:")
        print("  from ai_data import prepare_ai_data")
        print("  from ai_strategy import AIStrategy, evaluate_model")
        print()
        print("  # 데이터 준비")
        ...
        print()
        print("  # 평가")
        print("  evaluate_model(strategy, test_df, features)")
        print()
        print("  # 종목 선정")
        print("  result = strategy.select_stocks(test_df, features)")